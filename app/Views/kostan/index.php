        ...
        <div class="col-lg-3 rounded bg-grey p-3">
            ...
            <form action="/save" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="nama" name="nama" placeholder="Nama . . ." value="<?= old(
                                                                                                            "nama"
                                                                                                        ) ?>">
                </div>
                <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat Kostan</label>
                    <input class="form-control" id="alamat" name="alamat" placeholder="Alamat . . ." value="<?= old(
                                                                                                                "alamat"
                                                                                                            ) ?>">
                </div>
                <div class="mb-3">
                    ...
                    <div class="form-check ms-2 mt-1 border-top">
                        <input class="form-check-input" type="checkbox" value="ac" name="fitur[]">
                        <label class="form-check-label" for="flexCheckDefault">
                            AC
                        </label>
                    </div>
                    <div class="form-check ms-2 mt-1 border-top">
                        <input class="form-check-input" type="checkbox" value="kmdalam" name="fitur[]">
                        <label class="form-check-label" for="flexCheckChecked">
                            Kamar Mandi Dalam
                        </label>
                    </div>
                    <div class="form-check ms-2 mt-1 border-top">
                        <input class="form-check-input" type="checkbox" value="listrik" name="fitur[]">
                        <label class="form-check-label" for="flexCheckChecked">
                            Include Listrik
                        </label>
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="banyak_kamar" name="banyak_kamar" placeholder="Banyak Kamar . . ." value="<?= old(
                                                                          "banyak_kamar"
                                                                                                            ) ?>">
                    </div>
                    <div class="mb-3">
                        <label for="sisa_kamar" class="form-label">Sisa Kamar</label>
                        <input class="form-control" id="sisa_kamar" name="sisa_kamar" placeholder="Sisa Kamar . . ." value="<?= old(
                                                                          "sisa_kamar"
                                                                                                            ) ?>">
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga</label>
                        <input class="form-control" id="harga" name="harga" placeholder="Harga . . ." value="<?= old(
                                                                          "harga"
                                                                                                            ) ?>">
                    </div>
                </div>
